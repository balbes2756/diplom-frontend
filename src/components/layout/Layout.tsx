...
function Layout() {
    ...
    const handleProfileClick = (e: React.MouseEvent) => {
        ...
        if (!isAuthenticated) {
            ...
            // Авторизован → переходим в профиль
            navigate("/profile");
        }
    };
            ...
            <header className={styles.header}>
                <div className={styles.headerContent}>
                    ...
                    <nav className={styles.nav}>
                        {/* <Link
                            to="/"
                            className={`${styles.navIcon} ${location.pathname === "/" ? styles.active : ""}`}>
                            <svg
                                width="30"
                                height="30"
                                viewBox="0 0 30 30"
                                ...
                                <path
                                    d="M14.4772 0H15.4956C16.608 0.462351 16.5913 0.446157 17.4676 1.32271L18.5713 2.42786L22.075 5.93225L26.8545 10.7131L28.3666 12.223C28.9076 12.7613 29.478 13.2201 29.775 13.9379C29.8605 14.1491 29.9355 14.3644 30 14.583V15.4413C29.9325 15.6187 29.8698 15.7995 29.8054 15.9781C29.549 16.6891 29.025 17.2224 28.3367 17.5319C27.8531 17.746 27.3206 17.826 26.7953 17.7636L26.7931 24.2158L26.7951 25.9229C26.7953 26.3912 26.8237 26.9044 26.7299 27.3622C26.5036 28.4646 25.7416 29.4145 24.6685 29.7888C24.4922 29.8503 24.2624 29.9232 24.0989 30H18.5341C17.9461 29.6987 17.8468 29.3822 17.8669 28.7671C17.8766 28.4709 17.8676 28.138 17.8678 27.8395L17.8696 23.8812C17.8697 23.2583 17.9165 22.484 17.8536 21.8749C17.8335 21.6804 17.7827 21.4881 17.6857 21.3174C17.5034 20.9967 17.1637 20.7439 16.8074 20.6522C16.4165 20.5517 13.8543 20.5579 13.3856 20.6157C13.2012 20.6385 13.0283 20.6817 12.8676 20.7773C12.6341 20.916 12.3363 21.1736 12.2427 21.4366C12.1842 21.6008 12.1555 21.7815 12.142 21.9549C12.0901 22.6251 12.1287 23.3262 12.1288 24L12.1285 27.747C12.1289 27.9361 12.1332 28.13 12.1321 28.3194C12.1273 29.1211 12.2522 29.5518 11.4633 30H5.93042C5.19085 29.7173 4.71906 29.6383 4.12144 29.0175C3.65669 28.5349 3.38817 27.9682 3.2549 27.3125C3.18454 26.9666 3.20428 26.3877 3.20451 26.0207L3.20571 24.2079C3.20544 22.0775 3.18444 19.9125 3.21075 17.7848C2.76562 17.7805 2.31547 17.7768 1.88705 17.6251C1.19579 17.3803 0.646249 16.9225 0.304302 16.2694C0.188467 16.0482 0.113399 15.7415 0.0071032 15.517L0 15.5023V14.481C0.0311393 14.4354 0.117215 14.2185 0.135963 14.1593C0.397402 13.3338 0.958064 12.8723 1.56175 12.2704L3.01498 10.8187L7.68138 6.15015L11.3677 2.46542C12.0078 1.8248 12.6664 1.13738 13.3402 0.535793C13.587 0.315494 14.1535 0.145297 14.4772 0Z"
                                    fill="#f3f5ff"
                                />
                            </svg>
                        </Link> */}
                    ...
                    <div className={styles.footerContent}>
                        ...
                        <div className={styles.footerLeft}>
                            ...
                            <p className={styles.footerNote}>
                                ...
                                <br />© 2026 «Хвост на время» - сайт разработан
                                студентами группы ИЭ-22:
                                <br />
                                Бердников Константин
                                <br />
                                Крылова Александра. <br />
                                Все права защищены.
                            </p>
                        </div>
                        ...
                        <div className={styles.footerRight}>
                            <p className={styles.footerContactText}>
                                Вы также можете связаться с нами по контактному
                                номеру или напишите там на почту
                            </p>
                            ...
                            <div className={styles.footerDecorations}>
                                ...
                                <div className={styles.pawsDecoration}>
                                    <img src={Paws} alt="Лапки" />
                                </div>
                            </div>
                        </div>
                    </div>
